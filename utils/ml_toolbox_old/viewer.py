...
def confusion_matrix(y_true, y_pred, labs, show=False, save='pred.png', title="Confusion Matrix", ts=False):
    ...
    conf = tf.math.confusion_matrix(labels=y_true, predictions=y_pred).numpy()  # TODO move this to np and remove import
    ...
    plt.xticks(tick_marks, labs)
    plt.yticks(tick_marks, labs, rotation=45)
